  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 backdrop-blur-sm",
  {
    variants: {
      variant: {
        ...
        secondary:
          "glass-subtle border-secondary/30 text-secondary-foreground hover:glass-hover",
        destructive:
          "border-transparent bg-destructive/90 text-destructive-foreground hover:bg-destructive shadow-sm hover:shadow-md",
        outline: "glass-subtle border-border text-foreground hover:glass-hover",
      },
    },
    defaultVariants: {
      variant: "default",
